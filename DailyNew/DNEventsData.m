...
- (NSMutableDictionary *)hotEvents
{
	if (_hotEvents == nil) {
		_hotEvents = [@{
						...
						[@{@"title" : @"测试数据2", @"time" : @"这三天", @"location" : @"六教", @"like" : @14} mutableCopy],
						[@{@"title" : @"啦啦啦啦", @"time" : @"噗噗", @"location" : @"六教", @"like" : @155} mutableCopy],
						[@{@"title" : @"试试看", @"time" : @"嘿嘿", @"location" : @"六教", @"like" : @315} mutableCopy],
						[@{@"title" : @"牛", @"time" : @"一二三", @"location" : @"六教", @"like" : @15} mutableCopy],
						[@{@"title" : @"三日初创", @"time" : @"这两天", @"location" : @"六教", @"like" : @15} mutableCopy],
						[@{@"title" : @"测试数据2", @"time" : @"这三天", @"location" : @"六教", @"like" : @165} mutableCopy],
						...
						[@{@"title" : @"牛", @"time" : @"一二三", @"location" : @"光华楼", @"like" : @135} mutableCopy]],
						@3 : @[
					    [@{@"title" : @"三日初创", @"time" : @"这两天", @"location" : @"六教", @"like" : @432 } mutableCopy],
						[@{@"title" : @"三日初创", @"time" : @"这两天", @"location" : @"六教", @"like" : @15} mutableCopy],
						[@{@"title" : @"测试数据2", @"time" : @"这三天", @"location" : @"六教", @"like" : @165} mutableCopy],
						[@{@"title" : @"啦啦啦啦", @"time" : @"噗噗", @"location" : @"六教", @"like" : @125} mutableCopy],
						[@{@"title" : @"试试看", @"time" : @"嘿嘿", @"location" : @"六教", @"like" : @15} mutableCopy],
						[@{@"title" : @"测试数据2", @"time" : @"这三天", @"location" : @"六教", @"like" : @14} mutableCopy],
						[@{@"title" : @"啦啦啦啦", @"time" : @"噗噗", @"location" : @"六教", @"like" : @155} mutableCopy],
						[@{@"title" : @"试试看", @"time" : @"嘿嘿", @"location" : @"六教", @"like" : @315} mutableCopy],
						[@{@"title" : @"牛", @"time" : @"一二三", @"location" : @"六教", @"like" : @15} mutableCopy],
						[@{@"title" : @"牛", @"time" : @"一二三", @"location" : @"六教", @"like" : @135} mutableCopy]]
					  } mutableCopy];
	}
	return _hotEvents;
}
